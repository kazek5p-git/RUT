...
4. Jeśli program zamyka się od razu, uruchom `start_RUT_debug.cmd` i sprawdź pliki `.txt` w folderze `logs`.
5. Jeśli Windows albo program antywirusowy zapyta o zaufanie do pliku, potwierdź tylko wtedy, gdy ZIP pochodzi z powyższego release GitHub.
